  ...
  return (
    ...
    >
      <VStack textAlign="center" color="white" p={4}>
        ...
        <Link legacyBehavior href="/UploadItem"><a className="py-4 px-2 text-gray-500 hover:text-gray-700 transition duration-300">Click here to upload an Item</a></Link>
      </VStack>
    </Box>
  );
};
