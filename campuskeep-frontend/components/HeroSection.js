    ...
    >
      <div className=' bg-opacity-40 w-full p-10 flex flex-col items-center justify-center'>
        ...
        <div className='flex gap-2 mt-2'>
          <Link legacyBehavior href="/LostItems"><a className="py-4 px-12 rounded-lg bg-purple-900 hover:bg-purple-800 text-md transition duration-300 font-semibold">See Lost Items</a></Link>
        </div>
      </div>
    </Box>
